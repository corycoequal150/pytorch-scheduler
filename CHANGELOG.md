...
### Added
- `IdentityScheduler` — no-op scheduler that keeps the learning rate constant; useful as a baseline or when a scheduler interface is required but no scheduling is desired
